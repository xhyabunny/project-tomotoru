...
public class MediaSessionCompat {
    ...
    static class MediaSessionImplBase implements MediaSessionImpl {
        ...
        class MessageHandler extends Handler {
            ...
            public void handleMessage(Message msg) {
                Callback cb = (Callback) MediaSessionImplBase.this.mCallback;
                if (cb != null) {
                    switch (msg.what) {
                        case 1:
        ...
        public RemoteControlClient.MetadataEditor buildRccMetadata(Bundle metadata) {
            ...
            if (metadata != null) {
                ...
                if (metadata.containsKey(MediaMetadataCompat.METADATA_KEY_RATING)) {
                    editor.putObject(SakanaView.MOUSE_PRESSED, metadata.getParcelable(MediaMetadataCompat.METADATA_KEY_RATING));
                }
