    ...
    private static void extract(String s, int start, ExtractFloatResult result) {
        ...
        for (int currentIndex = start; currentIndex < s.length(); currentIndex++) {
            ...
            switch (s.charAt(currentIndex)) {
                ...
                case 'E':
                case SakanaView.MOUSE_PRESSED /*101*/:
                    isExponential = true;
                    break;
            }
            if (foundSeparator) {
    ...
    public static class PathDataNode {
        ...
        private static void addCommand(Path path, float[] current, char previousCmd, char cmd, float[] val) {
            ...
            switch (cmd) {
                ...
                case 'H':
                case 'V':
                case SakanaView.MOUSE_DRAGGED /*104*/:
                case 'v':
                    incr = 1;
                    break;
                case 'L':
                case 'M':
                case 'T':
                case SakanaView.MOUSE_EXITED /*108*/:
                case SakanaView.MOUSE_CANCELLED /*109*/:
                case SakanaView.MODAL_HMOUSE_WHEEL_MOVED /*116*/:
                    incr = 2;
                    break;
                case 'Q':
                case 'S':
                case SakanaView.MODAL_MOUSE_MOVED /*113*/:
                case SakanaView.MODAL_MOUSE_WHEEL_MOVED /*115*/:
                    incr = 4;
                    break;
                case 'Z':
                case 'z':
