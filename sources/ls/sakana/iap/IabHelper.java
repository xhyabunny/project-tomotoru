...
public class IabHelper {
    ...
    public boolean handleActivityResult(int r13, int r14, android.content.Intent r15) {
        ...
        L_0x0006:
            ...
            r12.logError(r8)
            ls.sakana.iap.IabResult r6 = new ls.sakana.iap.IabResult
            r8 = -1002(0xfffffffffffffc16, float:NaN)
            java.lang.String r9 = "Null data in IAB result"
            r6.<init>(r8, r9)
            ls.sakana.iap.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
        ...
        L_0x00e2:
            r2 = 0
            ls.sakana.iap.Purchase r3 = new ls.sakana.iap.Purchase     // Catch:{ JSONException -> 0x014b }
            ...
            boolean r8 = ls.sakana.iap.Security.verifyPurchase(r8, r4, r0)     // Catch:{ JSONException -> 0x0206 }
            ...
            ls.sakana.iap.IabResult r6 = new ls.sakana.iap.IabResult     // Catch:{ JSONException -> 0x0206 }
            ...
            ls.sakana.iap.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener     // Catch:{ JSONException -> 0x0206 }
        ...
        L_0x0132:
            ...
            ls.sakana.iap.IabHelper$OnIabPurchaseFinishedListener r8 = r12.mPurchaseListener
            ls.sakana.iap.IabResult r9 = new ls.sakana.iap.IabResult
            r10 = 0
        ...
        L_0x0206:
            ...
            goto L_0x014c
        */
        throw new UnsupportedOperationException("Method not decompiled: ls.sakana.iap.IabHelper.handleActivityResult(int, int, android.content.Intent):boolean");
    }
    ...
    public Inventory querySkuDetails(List<String> moreSkus) throws IabException {
        checkNotDisposed();
        checkSetupDone("queryInventory");
        try {
            Inventory inv = new Inventory();
            int r = querySkuDetails(ITEM_TYPE_INAPP, inv, moreSkus);
            if (r == 0) {
                return inv;
            }
    ...
    public void querySkuDetailsAsync(final List<String> moreSkus, final QueryInventoryFinishedListener listener) {
        final Handler handler = new Handler();
        checkNotDisposed();
        checkSetupDone("queryInventory");
        flagStartAsync("refresh inventory");
        new Thread(new Runnable() {
            public void run() {
                ...
                Inventory inv = null;
                try {
                    inv = IabHelper.this.querySkuDetails(moreSkus);
                } catch (IabException ex) {
                    result = ex.getResult();
                }
                IabHelper.this.flagEndAsync();
