...
public class Inventory {
    ...
    public String[] getPurchasedIDList() {
        return (String[]) this.mPurchaseMap.keySet().toArray(new String[0]);
    }

    public SkuDetails[] getSkuDetailsList() {
        return (SkuDetails[]) this.mSkuMap.values().toArray(new SkuDetails[0]);
    }
